...
// VirtualV1alpha1Client is used to interact with features provided by the virtual.equinixmetal.kubeform.com group.
type VirtualV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VirtualV1alpha1Client) Circuits(namespace string) CircuitInterface {
	return newCircuits(c, namespace)
}
