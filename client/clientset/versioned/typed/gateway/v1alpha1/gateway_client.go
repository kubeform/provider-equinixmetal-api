...
// GatewayV1alpha1Client is used to interact with features provided by the gateway.equinixmetal.kubeform.com group.
type GatewayV1alpha1Client struct {
	restClient rest.Interface
}

func (c *GatewayV1alpha1Client) Gateways(namespace string) GatewayInterface {
