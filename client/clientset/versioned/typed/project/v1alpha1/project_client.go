...
import (
	v1alpha1 "kubeform.dev/provider-equinixmetal-api/apis/project/v1alpha1"
...
// ProjectV1alpha1Client is used to interact with features provided by the project.equinixmetal.kubeform.com group.
type ProjectV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ProjectV1alpha1Client) ApiKeys(namespace string) ApiKeyInterface {
...
func (c *ProjectV1alpha1Client) SshKeys(namespace string) SshKeyInterface {
