...
func NewForConfig(c *rest.Config) (*IpV1alpha1Client, error) {
	...
	return &IpV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new IpV1alpha1Client for the given config and
...
func New(c rest.Interface) *IpV1alpha1Client {
	return &IpV1alpha1Client{c}
}
