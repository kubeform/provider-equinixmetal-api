...
type FakeConnections struct {
	Fake *FakeConnectionV1alpha1
	ns   string
}

var connectionsResource = schema.GroupVersionResource{Group: "connection.equinixmetal.kubeform.com", Version: "v1alpha1", Resource: "connections"}

var connectionsKind = schema.GroupVersionKind{Group: "connection.equinixmetal.kubeform.com", Version: "v1alpha1", Kind: "Connection"}
