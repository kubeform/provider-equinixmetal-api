...
var portsResource = schema.GroupVersionResource{Group: "port.equinixmetal.kubeform.com", Version: "v1alpha1", Resource: "ports"}

var portsKind = schema.GroupVersionKind{Group: "port.equinixmetal.kubeform.com", Version: "v1alpha1", Kind: "Port"}
...
func (c *FakePorts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Port, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(portsResource, c.ns, name), &v1alpha1.Port{})
...
func (c *FakePorts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PortList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(portsResource, portsKind, c.ns, opts), &v1alpha1.PortList{})
...
func (c *FakePorts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(portsResource, c.ns, opts))
...
func (c *FakePorts) Create(ctx context.Context, port *v1alpha1.Port, opts v1.CreateOptions) (result *v1alpha1.Port, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(portsResource, c.ns, port), &v1alpha1.Port{})
...
func (c *FakePorts) Update(ctx context.Context, port *v1alpha1.Port, opts v1.UpdateOptions) (result *v1alpha1.Port, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(portsResource, c.ns, port), &v1alpha1.Port{})
...
func (c *FakePorts) UpdateStatus(ctx context.Context, port *v1alpha1.Port, opts v1.UpdateOptions) (*v1alpha1.Port, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(portsResource, "status", c.ns, port), &v1alpha1.Port{})
...
func (c *FakePorts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(portsResource, c.ns, name), &v1alpha1.Port{})
...
func (c *FakePorts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(portsResource, c.ns, listOpts)
...
func (c *FakePorts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Port, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(portsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Port{})
