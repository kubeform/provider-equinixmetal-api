...
var keysResource = schema.GroupVersionResource{Group: "ssh.equinixmetal.kubeform.com", Version: "v1alpha1", Resource: "keys"}

var keysKind = schema.GroupVersionKind{Group: "ssh.equinixmetal.kubeform.com", Version: "v1alpha1", Kind: "Key"}
