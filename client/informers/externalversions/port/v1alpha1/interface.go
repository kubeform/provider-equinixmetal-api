...
// VlanAttachments returns a VlanAttachmentInformer.
func (v *version) VlanAttachments() VlanAttachmentInformer {
	return &vlanAttachmentInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
