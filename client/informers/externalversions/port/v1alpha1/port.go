	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PortV1alpha1().Ports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PortV1alpha1().Ports(namespace).Watch(context.TODO(), options)
			},
		},
		&portv1alpha1.Port{},
		resyncPeriod,
...
func (f *portInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&portv1alpha1.Port{}, f.defaultInformer)
}
