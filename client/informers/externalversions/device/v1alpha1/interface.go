...
type Interface interface {
	...
	// NetworkTypes returns a NetworkTypeInformer.
	NetworkTypes() NetworkTypeInformer
}
...
// NetworkTypes returns a NetworkTypeInformer.
func (v *version) NetworkTypes() NetworkTypeInformer {
	return &networkTypeInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
