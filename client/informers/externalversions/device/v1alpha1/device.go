	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DeviceV1alpha1().Devices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DeviceV1alpha1().Devices(namespace).Watch(context.TODO(), options)
			},
		},
		&devicev1alpha1.Device{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devicev1alpha1.Device{}, f.defaultInformer)
}
