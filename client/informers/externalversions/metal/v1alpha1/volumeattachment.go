	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MetalV1alpha1().VolumeAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MetalV1alpha1().VolumeAttachments(namespace).Watch(context.TODO(), options)
			},
		},
		&metalv1alpha1.VolumeAttachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&metalv1alpha1.VolumeAttachment{}, f.defaultInformer)
}
