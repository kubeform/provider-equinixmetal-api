	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectV1alpha1().ApiKeys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectV1alpha1().ApiKeys(namespace).Watch(context.TODO(), options)
			},
		},
		&projectv1alpha1.ApiKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *apiKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectv1alpha1.ApiKey{}, f.defaultInformer)
}
