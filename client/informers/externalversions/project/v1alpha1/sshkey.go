...
import (
	...
	v1alpha1 "kubeform.dev/provider-equinixmetal-api/client/listers/project/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectV1alpha1().SshKeys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectV1alpha1().SshKeys(namespace).Watch(context.TODO(), options)
			},
		},
		&projectv1alpha1.SshKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sshKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectv1alpha1.SshKey{}, f.defaultInformer)
}
