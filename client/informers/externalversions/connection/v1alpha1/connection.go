...
import (
	...
	v1alpha1 "kubeform.dev/provider-equinixmetal-api/client/listers/connection/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConnectionV1alpha1().Connections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConnectionV1alpha1().Connections(namespace).Watch(context.TODO(), options)
			},
		},
		&connectionv1alpha1.Connection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *connectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&connectionv1alpha1.Connection{}, f.defaultInformer)
}
