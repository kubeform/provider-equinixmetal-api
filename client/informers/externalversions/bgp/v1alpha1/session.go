...
import (
	...
	v1alpha1 "kubeform.dev/provider-equinixmetal-api/client/listers/bgp/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BgpV1alpha1().Sessions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BgpV1alpha1().Sessions(namespace).Watch(context.TODO(), options)
			},
		},
		&bgpv1alpha1.Session{},
		resyncPeriod,
...
func (f *sessionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bgpv1alpha1.Session{}, f.defaultInformer)
}
