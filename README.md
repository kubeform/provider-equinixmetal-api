[![CI](https://github.com/kubeform/provider-equinixmetal-api/actions/workflows/ci.yml/badge.svg)](https://github.com/kubeform/provider-equinixmetal-api/actions/workflows/ci.yml)
...
# provider-equinixmetal-api

Kubeform CRDs for [Terraform Equinix Metal Provider](https://github.com/equinix/terraform-provider-metal)
